...
Cache.prototype = {
    ...
    getId: function () {
        ...
        var url = this.method + " " + this.removeAuthFromString(this.url);
    ...
    serve: function(req, res){
        ...
        this.sendHeaders(res, metaData.status, metaData.headers);

        this.sendCachedBody(res);
    },

    sendCachedBody: function(res){
    ...
    onError: function(res, request, response){
        var r = response;
    },
    ...
    captureThenServe : function(options, data, res){
