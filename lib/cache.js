...
Cache.prototype = {
    ...
    onEnd: function(res, incomingMessage){
        ...
        console.log("Mimee of " + this.getId() + "is actually " + actualMime + " (headers said " + statedMime + ")");
    ...
    moveTempFiles: function(incomingMessage){
        ...
        try {
            ...
            console.warn('HEADERS_PUBLISH failed: ' + error + ", " + headers);
            this.handleUnhandledError(error);
            return;
        }
        ...
        try {
            ...
            console.log('BODY_PUBLISH succeeded' + headers);
        }catch(error) {
            console.warn('BODY_PUBLISH failed: ' + error + ", " + headers);
            this.handleUnhandledError(error);
            return;
        }
    },
