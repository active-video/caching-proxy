...
var CachingProxy = function(options) {
    ...
    console.log('Starting a caching proxy server on port ' + SERVER.PORT);
...
module.exports = {
    server: CachingProxy,//the constructor for the server
    start: startServer//a function to auto-start the server
};